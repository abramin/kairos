...
func ShellCommandSpec() *CommandSpec {
	return &CommandSpec{
		Commands: []CommandEntry{
			...
			{FullPath: "calendar sync", Short: "Push due items to Google Calendar via gws", Flags: []FlagEntry{{Name: "days", Type: "int", Default: "14", Description: "Number of days to look ahead"}}},
			...
			{FullPath: "project pause", Short: "Temporarily pause a project (excludes it from scheduling)"},
			{FullPath: "project resume", Short: "Resume a paused project (re-includes it in scheduling)"},
			...
			{FullPath: "chart", Short: "Show weekly time breakdown chart", Flags: []FlagEntry{{Name: "weeks", Type: "int", Default: "6", Description: "Number of weeks to show"}}},
			{FullPath: "workout log", Short: "Log a workout session", Flags: []FlagEntry{{Name: "date", Type: "string", Description: "Date (YYYY-MM-DD, defaults to today)"}, {Name: "notes", Type: "string", Description: "Optional notes"}}},
			{FullPath: "workout list", Short: "List recent workouts", Flags: []FlagEntry{{Name: "weeks", Type: "int", Default: "4", Description: "Number of weeks to show"}}},
			{FullPath: "workout delete", Short: "Delete a workout entry"},
			{FullPath: "tasks", Short: "Open global task checklist"},
